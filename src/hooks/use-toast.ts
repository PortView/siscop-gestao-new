...
// Use: import { toast, ToastProvider, ToastViewport } from '@/hooks/use-toast';
...
// Exporta um helper direto para uso como import { toast } from '@/hooks/use-toast';
export const toast = (message: string, type?: ToastType) => {
  // Precisa ser chamado dentro de um componente envolvido por ToastProvider
  throw new Error('Chame useToast() dentro do seu componente para acessar toast!');
};
